...
const BookingsForm = () => {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		createBooking({ variables: { ...booking } });
		openModal();
	};
									...
									<Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-slate-50 p-6 text-left align-middle shadow-xl transition-all">
										...
										<div className="mt-2">
											<p className="tracking-wide">
												Thank you for sharing this information with us. It has been sent
												to our team of Aerocruise Safari Specialists, where one of them
			...
			<div className="mx-auto max-w-4xl px-8 pb-10">
				<div className="mx-auto max-w-3xl rounded-lg bg-slate-50 px-4 py-8 shadow-lg sm:px-6 lg:px-8">
					...
					<form onSubmit={handleSubmit} className="py-6">
						<div className="flex flex-col sm:flex-row sm:gap-8">
							<div className="mb-4 flex-1">
								<label htmlFor="destination">
									Destination<span className="font-bold text-red-600">*</span>
								</label>
								<select
									name="destination"
						...
						<div className="flex flex-col sm:flex-row sm:gap-8">
							<div className="mb-4 flex-1">
								<label htmlFor="duration">
									Duration<span className="font-bold text-red-600">*</span>
								</label>
								<select
									name="duration"
									className="mt-1 w-full rounded-md border-2 border-gray-100 bg-gray-100 py-3 focus:border-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-200 focus:ring-offset-2"
						...
						<div className="flex flex-col sm:flex-row sm:gap-8">
							<div className="mb-4 flex-1">
								<label htmlFor="travelDate">Estimated Date of Travel</label>
								<input
									type="date"
									name="travelDate"
									className="mt-1 w-full rounded-md border-2 border-gray-100 bg-gray-100 py-3 focus:border-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-200 focus:ring-offset-2"
							...
							<div className="mb-4 flex-1">
								<label htmlFor="budget">
									Budget per Person<span className="font-bold text-red-600">*</span>
								</label>
								<select
									name="budget"
									className="mt-1 w-full rounded-md border-2 border-gray-100 bg-gray-100 py-3 focus:border-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-200 focus:ring-offset-2"
						...
						<div>
							<label>Who will you be travelling with?</label>
						</div>
						<div className="flex flex-col sm:flex-row sm:gap-8">
							<div className="mb-4 flex-1">
								<label htmlFor="adults">
									Adults (12+)<span className="font-bold text-red-600">*</span>
								</label>
								<input
									type="number"
									name="adults"
							...
							<div className="mb-4 flex-1">
								<label htmlFor="children">
									Children (2-11)<span className="font-bold text-red-600">*</span>
								</label>
								<input
									type="number"
									name="children"
							...
							<div className="mb-4 flex-1">
								<label htmlFor="infants">
									Infants (under 2)<span className="font-bold text-red-600">*</span>
								</label>
								<input
									type="number"
									name="infants"
						...
						<div className="flex flex-col sm:flex-row sm:gap-8">
							<div className="mb-5 flex-1">
								<label htmlFor="comments">
									Comments or Requests<span className="font-bold text-red-600">*</span>
								</label>
								<textarea
									className="mt-1 w-full rounded-md border-2 border-gray-100 bg-gray-100 py-3 focus:border-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-200 focus:ring-offset-2"
									name="comments"
									cols="30"
									rows="5"
									placeholder="Tell us how we can make your holiday even more memorable!"
									onChange={handleChange}
									required
								></textarea>
							</div>
